...
Because of that the same classes (|SCMJob| and |SCMResults|) are used as bases and hence preparation, running and results extraction for utility tools follow the same rules as the ADF program.

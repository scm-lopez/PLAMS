...
Input files for ADF consist of blocks and subblocks containg keys and values. That kind of structure can be easily reflected by |Settings| objects since they are built in a similar way.
